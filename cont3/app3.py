...
def callback(ch, method, properties, body, channel):
    ...
    if message['cont'] == 'cont2' and message['target'] == 'cont3':
        data = int(message['message']['data']) - 10
        send_message(channel, "cont3", "app3.py", "counter", data, 'cont1')
...
if __name__ == "__main__":
    print("Начало выполнения скрипта app3.py", file=sys.stderr)
    main()
